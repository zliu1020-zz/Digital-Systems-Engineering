...
foreach file [concat { util.vhd } { mem.vhd lab3.vhd components.vhd lab3_top.vhd }] {
  add_input_file $file
}  

compile

auto_write uw_tmp/lab3_top_gate.vhd
...
# generates uw_tmp/lab3_top_logic.v, .vhd
synthesize
...
auto_write uw_tmp/lab3_top_logic.sdf

report_constraints \
  -hierarchy \
  -clocks \
  uw_tmp/lab3_top_logic.sdc
