if { ![project_exists {lab3_top}] } {
     project_new {lab3_top}
} else {
     project_open {lab3_top}
}
set_project_settings -cmp {lab3_top}
if { ![project_settings_exist -sim lab3_top] } {
        set_project_settings -sim lab3_top
}
set_global_assignment -section_id {lab3_top} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {VQM_FILE} {lab3_top.vqm}
...
if { [file exists {lab3_top_altera.prop}] } {
  source lab3_top_altera.prop
}
set_global_assignment -name {FAMILY} {MAX 10 FPGA}
set_global_assignment -section_id {lab3_top} -name {DEVICE} {10M08SAE144C8GES}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {lab3_top_pnr_constraints.sdc}
